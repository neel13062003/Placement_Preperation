...
class Solution
{
    ...
    int solveRec(int wt[],int val,int index,int capacity){
        ...
        int include=0;
        if(wt[index]<= capacity) include = value[index]+ solveRec(wt,val,index-1,capacity-wt[index]); 
    ...
    int solveMem(int wt[],int val,int index,int capacity,vector<vector<int>>&dp){
        ...
        int include=0;
        if(wt[index]<= capacity) include = value[index]+ solveRec(wt,val,index-1,capacity-wt[index],dp); 
